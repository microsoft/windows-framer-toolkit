	...
	createLayers: ->
		...
		for i in [0..datePickerItems.length - 1]
			...
			if i is 0 or i is datePickerItems.length - 1
				monthText.color = dateText.color = yearText.color = SystemThemeColor.baseMediumLow
			else if i is 4
				monthText.color = dateText.color = yearText.color = SystemThemeColor.baseHigh
				itemContainer.backgroundColor = SystemThemeColor.listAccentLow
			else
				monthText.color = dateText.color = yearText.color = SystemThemeColor.baseMedium
